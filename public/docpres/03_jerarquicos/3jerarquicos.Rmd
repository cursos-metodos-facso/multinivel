...
- Descomposición de la varianza: permite obtener la proporción de la variable dependiente que se asocia a la pertenencia a unidades de nivel 2 (correlación intra-clase)
