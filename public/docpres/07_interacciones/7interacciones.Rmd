...
- rmarkdown::render('static/docpres/07_intercenter/7inter_center.Rmd', 'xaringan::moon_reader')
...
## Sesión 7: Interacciones entre niveles
]
...
```{r}
pacman::p_load(lme4,sjPlot,haven, texreg)
...
# Ejemplo 2: replicación Aguinis

**Best-Practice Recommendations for Estimating Cross-Level Interaction Effects Using Multilevel Modeling**


Herman Aguinis, Ryan K. Gottfredson and Steven Andrew Culpepper

Journal of Management 2013 39: 1490 originally published online 2 April 2013
DOI: 10.1177/0149206313478188

link [aquí](../../readings/Aguinis2014.pdf)
...
.center[![:scale 80%](../images/aguinis_teams.png)]
...
- [Guia F](../../practicas/f_interaccion.html)
